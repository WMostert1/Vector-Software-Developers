  ...
  (function(window, document, Chartist) {
    ...
    Chartist.plugins.tooltip = function(options) {
      ...
      return function tooltip(chart) {
        var tooltipSelector = '.ct-point, .ct-line';
        ...
        $chart.on('mouseenter', tooltipSelector, function() {
          ...
          if (options.tooltipFnc) {
              tooltipText = options.tooltipFnc($point.attr('ct:meta') || '', $point.attr('ct:value'), $point.parent().attr('ct:series-name'), $point.attr('class'));
          } else {
