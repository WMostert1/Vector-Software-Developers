...
namespace BugWeb
{
    public static class AutoMapperConfig
    {
        ...
        {
            AutoMapper.Mapper.CreateMap<DataAccess.Models.Block, BugBusiness.Interface.FarmManagement.DTO.BlockFarmManDto>();
            ...
            AutoMapper.Mapper.CreateMap<DataAccess.Models.Farm, BugBusiness.Interface.FarmManagement.DTO.FarmForFarmManDto>();
